        ...
        for start_idx in range(0, len(gpu_racks), CARDS_PER_ROW):
            ...
            for i, rack in enumerate(row_racks):
                ...
                with cols[i]:
                    ...
                    st.markdown(f'<span class="pg-pill" style="background-color:{pill_color}; color:#0f172a; font-size:1.25rem; font-weight:600; padding:6px 14px; border: 2px solid #0f172a;">{pill_text}</span>', unsafe_allow_html=True)
