...
# GPU racks: those with Rack SKU "GPU_GB300_NVL72_R.03" from the HSG17 - Placement Groups.txt file
# (user-provided authoritative source). Only these are shown in the dashboard
# "Errors by Category × Rack (per Placement Group)" tables (GPU racks only).
GPU_RACKS: set = {
